...
proc generateGoFile*(outDir: string, libName: string) {.compileTime, raises: [].} =
  ...
  # ---------------------- <libName>.go ----------------------
  # Native and CBOR generators write to separate <outDir> trees, so
  # each build dir has exactly one wrapper. No build tags needed; the
  # consumer's go.mod `replace` picks the active mode (matches how C/C++
  # / Rust select build vs build_cbor via their build system).
  var g = "// Generated by nim-brokers Go FFI codegen — do not edit.\n"
  g.add("//\n")
  g.add(
  ...
  if gApiGoEventCAdapterImpls.len > 0:
    var c = "// Generated by nim-brokers Go FFI codegen — do not edit.\n"
