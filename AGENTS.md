...
This project is indexed by GitNexus as **nim-brokers** (7205 symbols, 12694 relationships, 204 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
