...
This project is indexed by GitNexus as **nim-brokers** (5309 symbols, 9374 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
