...
This project is indexed by GitNexus as **nim-brokers** (1036 symbols, 1699 relationships, 10 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
